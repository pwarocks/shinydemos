...
exports.renderHomePage = function(tagNames) {
  var homepage = Handlebars.compile(fs.readFileSync(siteconfig.layoutsFolder + '/home.handlebars').toString());
...
exports.renderTagsPages = function(demosByTag) {
  var tagspage = Handlebars.compile(fs.readFileSync(siteconfig.layoutsFolder + '/tag.handlebars').toString()),
...
exports.renderDemos = function() {
  var optionsjs = Handlebars.compile(fs.readFileSync(siteconfig.layoutsFolder + '/options.handlebars').toString()),
      demosByTag = {}, 
      tagNames, optsjs;
